...
public class FlowRunnerInfant {
    ...
    //private static String URL_FIRST_PAGE_DEFAULT = "https://getaways2.datalex.jetblue.com/B6/CallCenterPortalStart.do";
    //private static String URL_FIRST_PAGE_DEFAULT = "https://getaways.datalex.jetblue.com/B6/CallCenterPortalStart.do";
    //private static String URL_FIRST_PAGE_DEFAULT = "https://datalex3.jetblue.com/B6/CallCenterPortalStart.do";
    private static String USERNAME_DEFAULT = "950200";
    private static String PASSWORD_DEFAULT = "DTLEX17";
    private static String ORIGINAL_LOCATION_DEFAULT = "JFK";
    private static String DESTINATION_LOCATION_DEFAULT = "BOS";
    private static String DEPARTURE_DATE_DEFAULT = "07/27/2017";
    private static String ARRIVE_DATE_DEFAULT = "08/16/2017";
    private static String CABIN_TYPE_DEFAULT = "Economy";
    private static int ADULT_NUMBER_OF_PASSNGER_DEFAULT = 0;
    private static int KIDS_NUMBER_OF_PASSNGER_DEFAULT = 0;
    private static int INFANT_NUMBER_OF_PASSNGER_DEFAULT = 0;
    private static int UMNR_NUMBER_OF_PASSNGER_DEFAULT = 2;
    ...
    private static String ADULT_YEAR_DEFAULT = "1983";
    private static String CHILD_YEAR_DEFAULT = "2005";
    private static String INFANT_YEAR_DEFAULT = "2016";
    private static String UMNR_YEAR_DEFAULT = "2010";
    ...
    private static String PRIMARY_PHONE_DEFAULT = "555-555-5555";
    ...
    private static String CARD_CARDHOLDER_PHONE_DEFAULT = "555-555-5555";


    private static String SPIDER_NUMBER_DEFAULT = "123";
    private static String SPIDER_NAME_DEFAULT = "CCAPAgent";
    private static String ADULT_TYPE = "ADLT";
    private static String CHILD_TYPE = "CHLD";
    private static String INFANT_TYPE = "INF";
    private static String UMNR_TYPE = "UMNR";

    private static String[] numbers = {"", "ONE", "TWO","THREE","FOUR","FIVE","SIX","SEVEN","EIGHT","NINE","TEN","ELEVEN","TWELVE"};
    ...
    */
    ...
    private void searchFlowPage(){
        ...
        wait.until(ExpectedConditions.textToBePresentInElement(By.xpath("//*[@id=\"drilldownItem1\"]"),ORIGINAL_LOCATION_DEFAULT));
        // Click on specified
        ...
        wait.until(ExpectedConditions.textToBePresentInElement(By.xpath("//*[@id=\"drilldownItem1\"]"),DESTINATION_LOCATION_DEFAULT));
        driver.findElement(By.xpath("//*[@id=\"drilldownItem1\"]")).click();
        ...
        adultSelector.selectByVisibleText(String.valueOf(ADULT_NUMBER_OF_PASSNGER_DEFAULT));

        Select kidsSelector = new Select(driver.findElement(By.id("guestTypes[1].amount")));
        kidsSelector.selectByVisibleText(String.valueOf(KIDS_NUMBER_OF_PASSNGER_DEFAULT));

        Select infantSelector = new Select(driver.findElement(By.id("guestTypes[2].amount")));
        infantSelector.selectByVisibleText(String.valueOf(INFANT_NUMBER_OF_PASSNGER_DEFAULT));

        Select umnrSelector = new Select(driver.findElement(By.id("guestTypes[3].amount")));
        umnrSelector.selectByVisibleText(String.valueOf(UMNR_NUMBER_OF_PASSNGER_DEFAULT));
    ...
    private void selectFlowResultPage(){
        ...
        //driver.findElement(By.xpath("//*[@id=\"popupBaggageLowestBundleIntDialog\"]/div[4]/table/tbody/tr/td[2]/a")).click();
    ...
    private void fillTtravalerInfoPage(){
        ...
        int counterOfPassengers = 0;
        int adultQty = ADULT_NUMBER_OF_PASSNGER_DEFAULT;
        int childQty = KIDS_NUMBER_OF_PASSNGER_DEFAULT;
        int infantQty = INFANT_NUMBER_OF_PASSNGER_DEFAULT;
        int umnrQty = UMNR_NUMBER_OF_PASSNGER_DEFAULT;



        // POPULATE ADULT PASSENGERS DETAILS
        for (;adultQty > 0; adultQty--){

            populateCommonTravelerDetails(counterOfPassengers, ADULT_TYPE);

            if (counterOfPassengers == 0){
                driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].advancedPassengerDetails(addressLine1)")).sendKeys(ADDRESS_LINE1_DEFAULT);
                driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].advancedPassengerDetails(cityName)")).sendKeys(CITY_DEFAULT);
                Select countrySelector = new Select(driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].advancedPassengerDetails(countryCode)")));
                countrySelector.selectByVisibleText(COUNTRY_DEFAULT);
                Select stateSelector = new Select(driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].advancedPassengerDetails(stateCode)Display")));
                stateSelector.selectByVisibleText(STATE_DEFAULT);
                driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].advancedPassengerDetails(postalCode)")).sendKeys(ZIPCODE_DEFAULT);
                driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].advancedPassengerDetails(personalEmail)")).sendKeys(EMAIL_DEFAULT);
                driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].homePhone.phoneNumber")).sendKeys(PRIMARY_PHONE_DEFAULT);
            }

            counterOfPassengers++;
        }

        for (;childQty > 0; childQty--){

            populateCommonTravelerDetails(counterOfPassengers, CHILD_TYPE);
            counterOfPassengers++;
        }

        for (;infantQty > 0; infantQty--){

            populateCommonTravelerDetails(counterOfPassengers, INFANT_TYPE);
            counterOfPassengers++;
        }

        for (; umnrQty> 0; umnrQty--){

            populateCommonTravelerDetails(counterOfPassengers, UMNR_TYPE);
    ...
    private void populateCommonTravelerDetails(int counterOfPassengers, String type){

        if (ADULT_TYPE.equals(type)){
            Select titleSelector = new Select(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("travellersInfo[" + counterOfPassengers + "].title"))));
            titleSelector.selectByVisibleText(TITLE_DEFAULT);
        }


        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("travellersInfo[" + counterOfPassengers + "].firstName"))).sendKeys(FIRST_NAME_DEFAULT+type+numbers[counterOfPassengers]);
        //driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].firstName")).sendKeys(FIRST_NAME_DEFAULT);
        driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].lastName")).sendKeys(SECOND_NAME_DEFAULT);
        driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].genderMale")).click();

        Select daySelector = new Select(driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].advancedPassengerDetails(dobDay)")));
        daySelector.selectByVisibleText(DAY_DEFAULT);
        Select monthSelector = new Select(driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].advancedPassengerDetails(dobMonth)")));
        monthSelector.selectByVisibleText(MONTH_DEFAULT);
        Select yearSelector = new Select(driver.findElement(By.id("travellersInfo[" + counterOfPassengers + "].advancedPassengerDetails(dobYear)")));


        if (ADULT_TYPE.equals(type)){
            yearSelector.selectByVisibleText(ADULT_YEAR_DEFAULT);
        } else if (ADULT_TYPE.equals(type)){
            yearSelector.selectByVisibleText(CHILD_YEAR_DEFAULT);
        } else if (INFANT_TYPE.equals(type)){
            yearSelector.selectByVisibleText(INFANT_YEAR_DEFAULT);
        } else if (UMNR_TYPE.equals(type)) {
            yearSelector.selectByVisibleText(UMNR_YEAR_DEFAULT);
        }
